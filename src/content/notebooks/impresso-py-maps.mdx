...
authors:
  - impresso-team
sha: 7f607ec56446d33c312a68f74e15e2e37499371f
date: 2025-04-25T14:56:18Z
...
Search will be made in French, English and German. Output is sorted by number of times the location occurs (in descending order `-count`)
...
entities_without_coordinates[['label', 'wikidataId', 'totalMentions', 'wikidataDetails.coordinates.latitude', 'wikidataDetails.coordinates.longitude', 'wikidataDetails.descriptions.fr']]
```
...
You see below some functions used to calculate extra details needed to plot data on a map. 
...
This second function creates an HTML used for rendering the hover pop-up. This way, you can create an interactive map using `ipyleaflet` package.
