...
authors:
  - impresso-team
title: Searching Relevant texts within an Embedding spaces
sha: 1b1cb5c32ccd6a4f594ddaedc5b8bb2003031de5
date: 2024-10-29T10:20:36Z
links: []
...
This is not how it will look within Datalab. Details about that go to Daniele, but let's just showcase the programmatic access through our API
