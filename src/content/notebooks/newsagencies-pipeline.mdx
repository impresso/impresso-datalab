---
githubUrl: https://github.com/impresso/impresso-datalab-notebooks/blob/main/annotate/newsagencies_pipeline_demo.ipynb
authors:
  - impresso-team
title: News Agencies Recognition with impresso-pipelines Package
...
links:
  ...
  - href: https://github.com/impresso/impresso-pipelines/tree/main/impresso_pipelines/newsagencies
    label: newsagencies
  - href: https://github.com/impresso/impresso-pipelines/tree/main
    label: Impresso Pipelines package
  - href: https://huggingface.co/impresso-project/ner-newsagency-bert-multilingual
    label: impresso Hugging Face model
  - href: https://github.com/impresso/impresso-pipelines/tree/main/impresso_pipelines/newsagencies
...
googleColabUrl: https://colab.research.google.com/github/impresso/impresso-datalab-notebooks/blob/main/annotate/newsagencies_pipeline_demo.ipynb
---
...
> Please, note that it might require you to restart kernel to apply changes. To do so, on Google Colab, go to *Runtime* and select *Restart session*.
...
- `model_id`: expects a string that specifies the identifier or path of the pretrained model to use (for example, the [impresso Hugging Face model](https://huggingface.co/impresso-project/ner-newsagency-bert-multilingual)).
