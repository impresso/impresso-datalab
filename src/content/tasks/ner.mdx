...
summary: Named Entity Recognition (NER) is the task of identifying and classifying named entities in text, such as people, locations, and organizations, which is essential for structuring information in historical corpora.
notebooks:
...
[NER Stacked BERT Multilingual](https://huggingface.co/impresso-project/ner-stacked-bert-multilingual-v1.1.0)

[NER Stacked BERT Multilingual Light](https://huggingface.co/impresso-project/ner-stacked-bert-multilingual-light)
