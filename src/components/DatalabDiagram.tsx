    ...
    >
      ...
      <g>
        <text transform="translate(120.74 69.5)">
          <tspan className="font-weight-bold h5">Backend</tspan>
        ...
        <text transform="translate(640 70.77)" textAnchor="middle">
        ...
        >
          ...
          <tspan x="84.27" y="28" letterSpacing="0em">
            o
          </tspan>
          <tspan x="92.65" y="28" letterSpacing="0em">
            t
          </tspan>
          <tspan x="96.95" y="28" letterSpacing="0em">
            a
          </tspan>
          <tspan x="104.61" y="28" letterSpacing="0em">
            tion API
          </tspan>
        </text>
        <text transform="translate(160 282.68)" textAnchor="middle">
          <tspan x="0" y="0" className="font-weight-bold h5">
            Impresso Annotation
          </tspan>
          <tspan x="0" y="18" className="small-caps">
            Services - via API
          </tspan>
        </text>
        <text transform="translate(160 498.18)" textAnchor="middle">
          <tspan x="0" y="0" className="font-weight-bold h5">
            Impresso Annotation
          </tspan>
          <tspan x="0" y="18" className="small-caps">
        ...
        <g>
          <text transform="translate(566.3 303.33)">
            <tspan x="0" y="0" className="small-caps">
              API time-limited token
            </tspan>
          </text>
          <text
            transform="translate(553.1 282.68)"
            className="font-weight bold h5"
          >
            <a
        ...
        <g>
          ...
          <g>
            ...
            >
              ...
              <tspan x="0" y="18">
                <a href="https://impresso-py.readthedocs.io">Readthedocs</a>{" "}
                (upcoming)
              </tspan>
            </text>
            <g opacity=".5">
        ...
        <g>
          ...
          <g>
            <text
              ...
              className="font-weight-bold h5"
            >
              <a href="https://huggingface.co/impresso-project" target="_blank">
