...
const LogoReadTheDocs: React.FC<LogoReadTheDocsProps> = ({
  ...
  const height = +width
  return (
    <div className={`LogoReadTheDocs SVG ${className}`}>
      <a
        href={href}
        target="_blank"
...
export default LogoReadTheDocs
